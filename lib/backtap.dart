...
class _BackTapPageState extends State<BackTapPage> {
  ...
  Future<void> _initializePermissions() async {
    ...
    if (locationStatus.isGranted) {
      ...
      if (microphoneStatus.isGranted) {
        ...
        _showPermissionDeniedSnackBar('Microphone permission is required.');
      }
    } else {
      _showPermissionDeniedSnackBar('Location permission is required.');
    }
  }
  ...
  void _triggerSOS() {
    ...
    _isTracking = true;
    _locationService.startLocationTracking(context).then((_) {
